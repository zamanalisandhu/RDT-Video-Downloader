    ...
    <main className="min-h-screen flex flex-col">
      ...
      <div className="flex-grow bg-white py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          <h1 className="text-4xl font-bold text-slate-900 mb-8">About RDT Video Downloader</h1>
          ...
          <div className="prose prose-slate max-w-none space-y-6 text-lg text-slate-600">
            ...
            <h2 className="text-2xl font-bold text-slate-900 mt-12 mb-4">Privacy &amp; Ethics</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-slate-900 mt-12 mb-4">Community Focused</h2>
            <p>
            ...
            <p className="mt-12 p-6 bg-slate-50 rounded-2xl border border-slate-100 italic">
